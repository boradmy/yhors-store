...
function productForm(product = {}, classifications = {}) {
  ...
  return `<form id="productForm"><div class="form-grid">
    ...
    <div class="field"><label for="sku">SKU</label><input id="sku" name="sku" required maxlength="40" pattern="[A-Za-z0-9][A-Za-z0-9._-]{0,39}" placeholder="Ej. YH-TEC-001" value="${escapeHTML(product.sku || '')}"><small class="field-help">Código único del producto. Puedes agregarlo o modificarlo.</small></div>
